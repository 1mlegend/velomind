          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-5 py-2 rounded-full bg-primary text-primary-foreground font-medium text-sm hover:shadow-[0_0_20px_hsl(267_100%_64%/0.3)] transition-all duration-300"
              >
                Launch App
              </button>
            </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span className="text-primary text-xs font-medium tracking-wide">Live on Solana</span>
            </motion.div>
            ...
            <p className="text-muted-foreground text-sm md:text-base max-w-lg mx-auto mb-10">
              Collective security. Privacy. Decentralized strength. Run private AI inference with cryptographic proof verification on Solana.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => navigate("/dashboard")}
                className="group px-8 py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-base hover:shadow-[0_0_30px_hsl(267_100%_64%/0.4)] transition-all duration-300 flex items-center justify-center gap-2"
              >
                Launch App
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-square rounded-3xl glass gradient-border flex items-center justify-center overflow-hidden" style={{ filter: 'hue-rotate(80deg) saturate(1.5) brightness(1.1)' }}>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-5 gap-8">
            {[
              ...
              { step: "05", title: "On-Chain", desc: "Proof anchored on Solana" },
            ].map((s, i, arr) => (
              <motion.div
                key={s.step}
                initial={{ opacity: 0, y: 20 }}
          ...
          <div className="mt-20 w-full aspect-video rounded-3xl overflow-hidden gradient-border" style={{ filter: 'hue-rotate(80deg) saturate(1.5) brightness(1.1)' }}>
            {/* @ts-ignore */}
      ...
      <footer className="border-t border-border/30 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-muted-foreground text-xs">
            © 2026 Velomind. Built on Solana. Privacy by design.
          </p>
